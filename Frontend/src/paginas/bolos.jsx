// Código completo corrigido para Bolos.jsx
...
export default function Bolos({ adicionarAoCarrinho }) {
  ...
  const bolos = produtos.filter(
    (produto) =>
      produto.tipo?.toLowerCase() === "bolo" ||
      produto.tipo?.toLowerCase() === "bolos"
  );
  ...
  return (
    <div className="container bolos-page">
      ...
      <div className="bolos-layout">
        ...
        <div className="products-wrapper">
          ...
          ADICIONAR <FiShoppingBag size={22} />
            ...
            <div className="text-center py-5">
              <h3>Nenhum bolo encontrado com os filtros aplicados.</h3>
