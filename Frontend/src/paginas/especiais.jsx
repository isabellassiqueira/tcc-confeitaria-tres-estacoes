// Código completo para Especiais.jsx (baseado em Bolos.jsx)
...
export default function Especiais({ adicionarAoCarrinho }) {
  ...
  // FILTRAR APENAS ESPECIAIS
  const especiais = produtos.filter(
    (produto) => produto.tipo?.toLowerCase() === "especial"
  );

  let filteredEspeciais = especiais
    .filter((p) =>
  ...
  return (
    <div className="container especiais-page">
      ...
      <div className="bolos-layout">
        ...
        <div className="products-wrapper">
          ...
          ADICIONAR <FiShoppingBag size={22} />
            ...
            <div className="text-center py-5">
              <h3>Nenhum especial encontrado com os filtros aplicados.</h3>
