// Código completo para Bebidas.jsx (baseado no Bolos.jsx)
...
export default function Bebidas({ adicionarAoCarrinho }) {
  ...
  const bebidas = produtos.filter(
    (produto) =>
      produto.tipo?.toLowerCase() === "bebida" ||
      produto.tipo?.toLowerCase() === "bebidas"
  );

  let filteredBebidas = bebidas
    .filter((p) =>
  ...
  return (
    <div className="container bebidas-page">
      ...
      <div className="bolos-layout">
        ...
        <div className="products-wrapper">
          ...
          ADICIONAR <FiShoppingBag size={22} />
            ...
            <div className="text-center py-5">
              <h3>Nenhuma bebida encontrada com os filtros aplicados.</h3>
