// Código completo para Salgados.jsx (baseado no Bolos.jsx)
...
export default function Salgados({ adicionarAoCarrinho }) {
  ...
  const salgados = produtos.filter(
    (produto) =>
      produto.tipo?.toLowerCase() === "salgado" ||
      produto.tipo?.toLowerCase() === "salgados"
  );

  let filteredSalgados = salgados
    .filter((p) =>
    ...
    <div className="container salgados-page">
      ...
      <div className="bolos-layout">
        ...
        <div className="products-wrapper">
          {filteredSalgados.length > 0 ? (
            filteredSalgados.map((produto) => (
              <div
                key={produto.id}
          ...
          ADICIONAR <FiShoppingBag size={22} />
            ...
            <div className="text-center py-5">
              <h3>Nenhum salgado encontrado com os filtros aplicados.</h3>
